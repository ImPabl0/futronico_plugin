...
import 'futronic_bindings_generated.dart';
...
const String _libName = 'futronic';

/// The dynamic library in which the symbols for [FutronicBindings] can be found.
...
final FutronicBindings _bindings = FutronicBindings(_dylib);
